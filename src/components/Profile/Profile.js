      ...
      <div className="profile__container">
        ...
        <form className='profile__form'>
          <div className="profile__form-li">
            ...
            <input type='text' placeholder='Виталий' className="profile__form-input" required />
          </div>
          <div className="profile__form-li">
            <p className="profile__form-input-label">E-mail</p>
            <input type='email' placeholder='pochta@yandex.ru' className="profile__form-input" required />
          </div>
